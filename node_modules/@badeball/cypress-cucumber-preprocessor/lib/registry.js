...
exports.getRegistry = exports.freeRegistry = exports.assignRegistry = exports.withRegistry = exports.Registry = void 0;
...
function parseHookArguments(options, fn, keyword) {
    return {
        id: (0, uuid_1.v4)(),
...
class Registry {
    ...
    resolveStepDefintion(text) {
        const matchingStepDefinitions = this.stepDefinitions.filter((stepDefinition) => stepDefinition.expression.match(text));
        if (matchingStepDefinitions.length === 0) {
            ...
            throw new Error(`Multiple matching step definitions for: ${text}\n` +
                matchingStepDefinitions
                    ...
                    else if (expression instanceof cucumber_expressions_1.CucumberExpression) {
...
function getRegistry() {
    return (0, assertions_1.assertAndReturn)(globalThis[globalPropertyName], "Expected to find a global registry (this usually means you are trying to define steps or hooks in support/index.js, which is not supported)");
}
