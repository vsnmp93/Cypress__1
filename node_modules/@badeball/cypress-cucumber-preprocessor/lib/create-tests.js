...
function createTests(registry, source, gherkinDocument, pickles, messagesEnabled, omitFiltered) {
    ...
    const testFilter = collectTagNamesFromGherkinDocument(gherkinDocument).includes("@focus")
        ? (0, tag_expressions_1.default)("@focus")
        : environmentTags
    ...
    afterEach(function () {
        ...
        if (remainingSteps.length > 0) {
            const error = (0, assertions_1.assertAndReturn)((_b = (_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.err) === null || _b === void 0 ? void 0 : _b.message, "Expected to find an error message");
            ...
            const testStepId = (0, assertions_1.assertAndReturn)((_d = (_c = failedStep.hook) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : (_e = failedStep.pickleStep) === null || _e === void 0 ? void 0 : _e.id, "Expected a step to either be a hook or a pickleStep");
                ...
                : {
                    testStepFinished: {
                        ...
                        testStepResult: {
                            ...
                            message: (_g = (_f = this.currentTest) === null || _f === void 0 ? void 0 : _f.err) === null || _g === void 0 ? void 0 : _g.message,
                        },
                    },
                };
            messages.push(failedTestStepFinished);
            for (const skippedStep of remainingSteps) {
                const testStepId = (0, assertions_1.assertAndReturn)((_j = (_h = skippedStep.hook) === null || _h === void 0 ? void 0 : _h.id) !== null && _j !== void 0 ? _j : (_k = skippedStep.pickleStep) === null || _k === void 0 ? void 0 : _k.id, "Expected a step to either be a hook or a pickleStep");
                messages.push({
                    testStepStarted: {
                        testStepId,
                        testCaseStartedId,
